...
// Initialize provides a mock function with given fields: _a0, channelUrl, channelToken, region, signer, credentials
func (_m *IWebSocketChannel) Initialize(_a0 log.T, channelUrl string, channelToken string, region string, signer *v4.Signer, credentials aws.Credentials) {
	_m.Called(_a0, channelUrl, channelToken, region, signer, credentials)
}
