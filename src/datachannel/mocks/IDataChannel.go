...
// SetWebsocket provides a mock function with given fields: _a0, streamUrl, tokenValue, region, signer, credentials
func (_m *IDataChannel) SetWebsocket(_a0 log.T, streamUrl string, tokenValue string, region string, signer *v4.Signer, credentials aws.Credentials) {
	_m.Called(_a0, streamUrl, tokenValue, region, signer, credentials)
}
